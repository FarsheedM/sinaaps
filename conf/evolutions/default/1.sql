...
create table blog_post(post_id int,title varchar(100), content  mediumText,image  varchar(200),author_id int,topic  varchar(100),language  varchar(50),primary key (post_id), foreign key (author_id) references author (author_id));
